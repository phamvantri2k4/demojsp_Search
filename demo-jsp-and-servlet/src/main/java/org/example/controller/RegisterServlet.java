...
import main.java.org.example.DAO.UserDAO; // Giao diện để truy vấn dữ liệu người dùng
import main.java.org.example.DAO.UserDAOImpl; // Lớp triển khai cụ thể của UserDAO
