...
import main.java.org.example.DAO.FollowDAO; // Giao diện để xử lý hành động follow/unfollow
import main.java.org.example.DAO.FollowDAOImpl; // Lớp triển khai cụ thể của FollowDAO
import main.java.org.example.DAO.UserDAOImpl; // Lớp để truy vấn thông tin người dùng
import main.java.org.example.model.User; // Lớp mô hình đại diện cho thông tin người dùng
