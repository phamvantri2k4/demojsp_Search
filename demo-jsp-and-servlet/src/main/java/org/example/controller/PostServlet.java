...
import main.java.org.example.DAO.PostsDAO; // Công cụ để làm việc với bài viết trong cơ sở dữ liệu
import main.java.org.example.DAO.PostsDAOImpl; // Phần thực hiện cụ thể của PostsDAO
import main.java.org.example.model.Posts; // Đại diện cho thông tin của một bài viết (tiêu đề, nội dung, v.v.)
import main.java.org.example.model.User; // Đại diện cho thông tin của một người dùng (ID, tên, v.v.)
