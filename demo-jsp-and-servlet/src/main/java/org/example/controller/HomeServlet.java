...
import main.java.org.example.DAO.PostsDAO; // Giao diện để truy vấn dữ liệu bài viết
import main.java.org.example.DAO.PostsDAOImpl; // Lớp triển khai cụ thể của PostsDAO
import main.java.org.example.model.Posts; // Lớp mô hình đại diện cho thông tin bài viết
